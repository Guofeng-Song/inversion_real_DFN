...
'''pickle C,D and ICDF for uncorrelated simulations'''
input_filename = 'E:/standford_paper/general_distribution/paper/OutputSimulation_ten_seconds/p_a_10000_10s.txt'
input_CD = np.loadtxt(fname=input_filename)


pdf_filename = 'E:/standford_paper/general_distribution/paper/OutputSimulation_ten_seconds/corr_20pdf_20220818.pkl'
...
with open('E:/standford_paper/general_distribution/paper/OutputSimulation_ten_seconds/CD_ICDF_20220818.pkl', 'wb') as file:
