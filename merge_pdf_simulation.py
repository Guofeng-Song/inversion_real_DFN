...
def merge_pdf(dir='', filename='combined_seeds', seed_n=20, ):
    pdf_simu = {'pdf' + str(i): {} for i in range(1, 10001)}##the value is 3001 when 3000 reference data in the full range is employed
    os.chdir(dir)
...
if __name__ == '__main__':
    ...
    dirs = [
        'E:/standford_paper/general_distribution/paper/OutputSimulation_ten_seconds'
        ]
    filenames = [
        # 'corr_100_20pdf.pkl',
        # 'corr_1000_20pdf.pkl',
        'corr_20pdf_20220818.pkl'
        ]
    start = time.time()
